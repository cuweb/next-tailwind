                  ...
                  <table className="min-w-full divide-y divide-gray-100">
                    <thead className="bg-gray-50">
                      <tr className="bg-gray-50 ">
                        <th
                          scope="col"
                          className="py-3.5  pl-4 pr-3 text-left text-sm font-semibold text-cu-black-900 sm:pl-6"
                        >
                          Leave Type
                        </th>
                        <th
                          scope="col"
                          className="px-3 py-3.5 text-center  text-sm font-semibold text-cu-black-900"
                        >
                          Begining Balance
                        </th>
                        <th
