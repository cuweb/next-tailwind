        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
            <div className="flex h-16 justify-between">
                            ...
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                {features.map((item) => (
                                  ...
                                  >
                                    <item.icon
                                      className="h-6 w-6 flex-shrink-0 text-red-carleton"
                                      aria-hidden="true"
                                    />
                                    <div className="ml-4">
              ...
              <div className="flex flex-1 items-center justify-center px-2 lg:ml-10 lg:justify-end">
                <div className="w-full max-w-lg lg:max-w-xs">
                  ...
                  <div className="relative">
                    ...
                    <input
                      id="search"
                      name="search"
                      className="block w-full rounded-md border border-gray-300 bg-white py-2 pl-10 pr-3 leading-5 placeholder-gray-500 focus:border-red-carleton focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-red-carleton sm:text-sm"
                      placeholder="Search"
                      type="search"
                    />
                  </div>
              ...
              <div className="flex items-center lg:hidden">
                {/* Mobile menu button */}
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-carleton">
              ...
              <div className="hidden lg:ml-4 lg:flex lg:items-center">
                <button className="flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-200 focus:ring-offset-2">
                  <span className="sr-only">View notifications</span>
                  <BellIcon className="h-6 w-6" aria-hidden="true" />
                </button>

                {/* Profile dropdown */}
                <Menu as="div" className="relative z-[100] ml-4 flex-shrink-0">
                  {({ open }) => (
                    <>
                      <div>
                        <Menu.Button className="flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-red-carleton focus:ring-offset-2">
          ...
          <Disclosure.Panel className="lg:hidden">
            <div className="space-y-1 pt-2 pb-3">
              {/* Current: "bg-red-carleton-50 border-red-carleton text-red-carleton-700", Default: "border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800" */}
              <a
                href="#"
                className="bg-red-carleton-50 text-red-carleton-700 block border-l-4 border-red-carleton py-2 pl-3 pr-4 text-base font-medium"
              >
                Dashboard
              </a>
              <a
            ...
            <div className="border-t border-gray-200 pt-4 pb-3">
              <div className="flex items-center px-4">
                ...
                <button className="ml-auto flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-red-carleton focus:ring-offset-2">
                  <span className="sr-only">View notifications</span>
                  <BellIcon className="h-6 w-6" aria-hidden="true" />
                </button>
              </div>
