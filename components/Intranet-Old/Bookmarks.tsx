				...
				<div className="overflow-hidden ">
					...
					<div className="my-10 text-center">
						...
						<div className="mt-6">
							<button
								type="button"
								className="inline-flex items-center px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md shadow-sm bg-cu-red hover:bg-cu-black-700 focus:outline-none focus:ring-2 focus:ring-cu-black-100 focus:ring-offset-2"
							>
								<PlusIcon
