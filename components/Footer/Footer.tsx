...
const Footer = () => {
  return (
    <footer
      className="bg-gray-carleton bg-[url('https://carleton.ca/assets/waves.svg')] bg-[length:100%] bg-bottom bg-no-repeat"
