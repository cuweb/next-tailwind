export default function NumberCardCenter() {
	...
	return (
		<div
			className={`not-prose relative flex flex-col gap-2 rounded-lg border border-l-8 border-cu-black-100 bg-white px-6 py-5 text-center shadow-lg md:max-w-lg ${color}`}
		>
