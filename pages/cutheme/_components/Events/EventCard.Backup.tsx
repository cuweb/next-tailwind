export default function EventCardBackup() {
	return (
		<div className="relative flex-col hidden overflow-hidden duration-300 ease-in rounded-lg shadow-lg not-prose group hover:scale-105 md:max-w-lg">
