...
export default function PeopleCardBackup() {
	return (
		<div className="relative hidden overflow-hidden duration-300 ease-in bg-white rounded-lg shadow-lg not-prose group hover:scale-105 md:max-w-lg">
