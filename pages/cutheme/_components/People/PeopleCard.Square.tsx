...
export default function PeopleCardSquare() {
	return (
		<div className="not-prose group relative flex flex-col overflow-hidden rounded-lg bg-white py-8 px-7 shadow-lg duration-300 ease-in @container hover:scale-105 md:max-w-lg">
			...
			>
				<img
					className="mx-auto h-48 w-48 rounded-lg border-4 border-white object-cover group-hover:shadow-md group-hover:duration-300 group-hover:ease-in @sm:md:h-60 @sm:md:w-60"
				...
				<div className="flex flex-col items-center space-y-0.5 py-6 px-7">
					...
					<ul className="pt-2 space-y-1 text-center">
