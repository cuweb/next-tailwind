								...
								<div className="px-4 py-8 space-y-6 bg-white md:px-0">
									...
									<form action="#" method="POST">
										<div className="flex flex-col mt-8">
																				...
																				<div className="relative flex items-start">
																					<div className="flex items-center h-5">
																						<input
																							...
																							className="w-4 h-4 border-gray-300 rounded text-cu-red focus:ring-cu-red-500"
																						/>
																					</div>
											...
											<div className="px-2 py-6 text-right md:px-0">
												<button
													type="submit"
													className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md shadow-sm bg-cu-red hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-cu-red-500 focus:ring-offset-2"
												>
													Save
												</button>
											</div>
