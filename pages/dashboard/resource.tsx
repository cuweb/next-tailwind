                ...
                <div className="space-y-6 bg-white py-8 px-4 md:px-0">
                  ...
                  <form action="#" method="POST">
                    <div className="mt-8 flex flex-col">
                                      ...
                                      <div className="relative flex items-start">
                                        <div className="flex h-5 items-center">
                                          <input
                                            ...
                                            className="h-4 w-4 rounded border-gray-300 text-cu-red focus:ring-cu-red-500"
                                          />
                                        </div>
                      ...
                      <div className="py-6 px-2 text-right md:px-0">
                        <button
                          type="submit"
                          className="inline-flex justify-center rounded-md border border-transparent bg-cu-red py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-cu-red-500 focus:ring-offset-2"
                        >
                          Save
                        </button>
                      </div>
