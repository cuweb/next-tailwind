      ...
      <main className="mx-auto max-w-7xl pb-14 md:pb-0">
        <Column cols="2/3">
          <div>
            ...
            <Menu as="div" className="relative mt-8 inline-block text-left">
              <div>
            ...
            <div className="sticky top-28">
              <div className="mb-6 flex gap-6">
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-md bg-cu-red px-4 py-3 font-medium text-white hover:bg-cu-black-600 focus:outline-none"
                >
                ...
                <button
                  ...
                  className="false border-1 inline-flex items-center justify-center rounded-md border border-cu-red bg-white px-4 py-3 font-medium text-white text-cu-red hover:bg-cu-red hover:text-white focus:outline-none"
                >
                  <span className="mr-2"></span>
                  Register Now
                </button>
