            ...
            <div className="sticky top-28">
              ...
              <dl className="mt-5 grid gap-4">
                {features.map((feature) => (
                  ...
                  >
                    <dt>
                      <div className="absolute top-5 flex h-10 w-10 justify-center text-cu-black-400">
              ...
              <ul className="mt-4 flex flex-wrap gap-2">
                <li className="inline-flex">
                  <a
                    href="#"
                    className="flex items-center whitespace-nowrap rounded-md bg-cu-black-100 px-2 py-1 text-xs font-semibold text-cu-black-700 hover:bg-cu-red hover:text-white"
                  >
