    ...
    <>
      ...
      <main className="mx-auto max-w-7xl pb-14 md:pb-0">
        <Column.TwoThird>
          ...
          <aside>
            <div className="mt-4 flex-1 flex-row bg-white">
              <button className="mr-2 mb-2 rounded-md bg-cu-red px-4 py-2 text-sm font-medium text-white hover:bg-gray-300">
                Category 1
              </button>

              <button className="mr-2 mb-2 rounded-md bg-cu-red px-4 py-2 text-sm font-medium text-white hover:bg-red-700">
                Category 2
              </button>
            </div>
            <dl className="mt-5 space-y-0  md:grid md:grid-cols-1 md:gap-x-0 md:gap-y-4 md:space-y-0">
              {features.map((feature) => (
                ...
                >
                  <dt>
                    <div className="absolute top-5 flex h-10 w-10 justify-center text-cu-blue-300">
