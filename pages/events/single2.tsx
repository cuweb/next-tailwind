				...
				<Column.TwoThird>
					...
					<aside className="relative">
						<div className="sticky top-28">
							<div className="flex-row flex-1 mt-4 bg-white">
								<button className="px-4 py-2 mb-2 mr-2 text-sm font-medium text-white rounded-md bg-cu-red hover:bg-gray-300">
									Category 1
								</button>

								<button className="px-4 py-2 mb-2 mr-2 text-sm font-medium text-white rounded-md bg-cu-red hover:bg-red-700">
									Category 2
								</button>
							</div>
							<dl className="mt-5 space-y-0 md:grid md:grid-cols-1 md:gap-x-0 md:gap-y-4 md:space-y-0">
								{features.map((feature) => (
									...
									>
										<dt>
											<div className="absolute flex justify-center w-10 h-10 top-5 text-cu-blue-300">
												<feature.icon
													className="w-6 h-6"
													aria-hidden="true"
												/>
