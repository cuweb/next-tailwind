...
const EventCalendar: NextPage = () => {
	return (
		<>
			...
			<header className="relative px-8 mx-auto max-w-7xl">
			...
			<main className="mx-auto max-w-7xl pb-14 md:pb-0">
				<Column>
					...
					<aside>
						...
						<button
							type="button"
							className="items-center w-full p-6 mb-4 text-lg font-medium text-white border border-transparent rounded-md shadow-sm bg-cu-blue-600 last:mb-0 hover:bg-cu-blue hover:text-white focus:outline-none focus:ring-2 focus:ring-cu-blue-100 focus:ring-offset-2"
						>
							Add to My Events{" "}
						...
						<div className="mt-3 rounded-md shadow sm:mt-0">
							...
							>
								<div>
									<Menu.Button className="flex items-center justify-center w-full p-6 text-base font-medium bg-white border-2 rounded-md border-cu-red text-cu-red hover:bg-cu-red hover:text-white md:text-lg">
										<ShareIcon
