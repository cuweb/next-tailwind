	...
	return (
		<div className="relative flex flex-col overflow-hidden rounded-lg shadow-lg">
			<div className="absolute px-6 top-48">
				<div className="flex flex-col items-center justify-center w-16 h-16 transform -translate-y-1/2 rounded-lg shadow bg-cu-red">
			...
			<div className="flex flex-col justify-between flex-1 p-6 bg-white">
				<div className="flex-1">
					<a href="TITLE" className="block mt-6">
			...
			<div className="flex">
				...
				<a
					href={link}
					className="flex items-center px-6 ml-auto rounded-br-lg bg-cu-black-100 text-cu-red hover:bg-cu-red-800 hover:text-white"
				>
					<svg
